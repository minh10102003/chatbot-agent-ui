...
function ButtonGroup({
  ...
  return (
    <div className="flex flex-row items-center justify-center gap-0">
      <Button
        variant={showingState ? "brand" : "outline"}
        className={cn(
          "rounded-l-md rounded-r-none border-r-0",
          showingState ? "" : "bg-muted text-muted-foreground"
        )}
        size="sm"
      ...
      <Button
        variant={showingDescription ? "brand" : "outline"}
        className={cn(
          "rounded-l-none rounded-r-md border-l-0",
          showingDescription ? "" : "bg-muted text-muted-foreground"
        )}
        size="sm"
    ...
    <div className="flex min-h-full w-full flex-col gap-9">
      ...
      <div className="flex w-full flex-wrap items-center justify-between gap-3">
        <div className="flex items-center justify-start gap-3">
          <p className="text-2xl tracking-tighter text-card-foreground">{threadTitle}</p>
