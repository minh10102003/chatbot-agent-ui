      ...
      {Object.entries(args).map(([k, v]) => {
        ...
        return (
          ...
          >
            ...
            <span className="w-full max-w-full rounded-xl bg-muted p-3 text-[13px] leading-[18px] text-card-foreground">
...
function ResponseComponent({
  ...
  return (
    <div className="flex w-full flex-col items-start gap-4 rounded-xl border border-border bg-card p-6">
...
function EditAndOrAcceptComponent({
  ...
  return (
    <div className="flex w-full flex-col items-start gap-4 rounded-xl border border-border bg-card p-6">
      <div className="flex w-full items-center justify-between">
        <p className="text-base font-semibold text-card-foreground">{header}</p>
