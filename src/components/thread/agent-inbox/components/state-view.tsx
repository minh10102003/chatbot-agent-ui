  ...
  if (Array.isArray(props.value)) {
    ...
    return (
      <div className="flex w-full flex-row items-start justify-start gap-1">
        <span className="font-normal text-card-foreground">[</span>
    ...
    <div className="relative flex flex-row items-start justify-start gap-2 text-sm">
      ...
      >
        <div
          ...
          className="flex h-5 w-5 cursor-pointer items-center justify-center rounded-md text-muted-foreground transition-colors ease-in-out hover:bg-muted hover:text-card-foreground"
        >
  ...
  return (
    <div
      className={cn(
        ...
        view === "state" &&
          "border-t border-border lg:border-t-0 lg:border-l border-border",
      )}
    >
      {view === "description" && (
